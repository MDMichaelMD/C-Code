...
void printGrid(int* grid, int gridLength); //t

int main() {     //Define a grid (for example, a 3x3 grid)
int grid[] = {         1, 2, 3,         4, 5, 6,         7, 8, 9    };
        int gridLength = 3;  // The length of one side of the square grid// Call the printGrid function and pass the grid and its length    
        printGrid(grid, gridLength);     return 0; } // Function definition
